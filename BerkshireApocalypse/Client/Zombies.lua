...
--[[addEventHandler("onClientRender",root,function()
	--if(GUIEditor.isWindow())then
        ...
        dxDrawRectangle(1162*(x/1440), 798*(y/900), 268*(x/1440), 92*(y/900), tocolor(0, 0, 0, 225), false)
        --dxDrawText(language[language.get(localPlayer)][11][1].."\n"..dcount, 1172*(x/1440), 810*(y/900), 1420*(x/1440), 880*(y/900), tocolor(255, 255, 255, 255), 1.20, "default-bold", "center", "center", false, true, false, false, false)
