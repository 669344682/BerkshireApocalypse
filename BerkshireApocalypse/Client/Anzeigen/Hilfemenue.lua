...
hilfemenue = {state = false,
	...
	["Texte"] = {
		[0] = {
			...
			--["Kisten"] = "Bei uns gibt es Kisten, in denen sich Dinge wie z.B. Erfahrungspunkte, Geld, Privatfahrzeuge und Skins befinden. Jeden Freitag bekommt man eine kostenlose Kiste. Kisten lassen sich allerdings auch mit Coins im Coinshop kaufen. Seine Kisten findet man in seinem Inventar unter 'I', in welchem man sie per Doppelklick benutzen kann.",
		...
		[1] = {
			...
			--["Chests"] = "We have chests in which things like Experience points, money, private vehicles and skins are located. Every Friday you get a free chest. Chests can also be bought with coins in the Coinshop. You find your chests in your inventory under 'I', in which you can open them by double-clicking.",
