...
function Payday.dxDraw()
	if(isWindowOpen() and not(isPlayerMapVisible(localPlayer)))then
		...
		dxDrawText("+ "..Payday.money.."$\n\n+ "..Payday.experiencePoints.." Experience Points\n\n+ "..Payday.coins.." Berkshire-Coins", 10*(x/1440), 346*(y/900), 222*(x/1440), 518*(y/900), tocolor(255, 255, 255, 200), 1.00, "default-bold", "center", "top", false, false, false, false, false)
