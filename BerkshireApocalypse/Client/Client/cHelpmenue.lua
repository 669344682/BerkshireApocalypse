...
Helpmenue = {
	["Categorys"] = {"Clicksystem","Bonuspoints","Protection Zones","Weapon Stores","Zombies","Levelsystem","Team","Premium","Achievements"},
	["Texts"] = {
		...
		["Zombies"] = "Near a player can spawn up to 50 zombies, which should be killed if you do not want to die. By killing a zombie you get 25$ and five experience points.",
		...
		["Achievements"] = "Under F3 you can open the Achievement-Panel, where you find all available achievements and there tasks. For each achievement you get a trophy, which gives you 25 experience points on payday.",
	},
};
