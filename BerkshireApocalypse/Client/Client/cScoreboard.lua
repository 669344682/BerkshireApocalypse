...
function Scoreboard.dxDraw()
    ...
    dxDrawText("Information", 935*(x/1440), 287*(y/900), 1017*(x/1440), 308*(y/900), tocolor(255, 255, 255, 255), 1.00, "default-bold", "center", "center", false, false, false, false, false)
	...
	for i = 1 + Scoreboard.scroll,12 + Scoreboard.scroll do
		if(pl[i])then
			...
			dxDrawText(pl[i].information, 935*(x/1440), 322*(y/900)+(17*id)+13, 1017*(x/1440), 343*(y/900)+(17*id)+13, tocolor(pl[i].colors[1],pl[i].colors[2],pl[i].colors[3], 255), 1.00, "default-bold", "center", "center", false, false, false, false, false)
